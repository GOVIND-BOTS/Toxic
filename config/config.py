...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6008136265").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/tha_govind_op"
